...
export default function CreateConference() {
  ...
  const [venue, setVenue] = useState('Hyderabad International Convention Centre')
  ...
  const [topicsText, setTopicsText] = useState('Generative AI, Ethics, Neural Systems')
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const created = await adminConferenceService.create({
        title: title.trim(),
        slug: slug.trim(),
        category,
      ...
      showSuccess(`Conference "${created.title}" created successfully!`)
      navigate(ROUTES.adminConferences)
    } catch {
      showError('Failed to create conference. Please try again.')
    } finally {
      setSubmitting(false)
    }
  }
  ...
  return (
    <div className="az-admin-page">
      ...
      <div className="az-admin-page__header">
        <div>
          <h1 className="az-admin-page__title">Add New Conference</h1>
          <p className="az-admin-page__subtitle">
            Configure metadata, dates, venue, pricing, and submission deadlines.
          </p>
        </div>
          ...
          <div className="az-admin-form-grid">
            <div className="az-grid-col-2">
              <Input
                ...
                placeholder="e.g. Global AI & Neural Computing Summit 2027"
                error={errors.title}
              />
            </div>
            ...
            <div>
              <Input
                ...
                placeholder="e.g. global-ai-neural-computing-2027"
                error={errors.slug}
                helperText="Unique URL identifier for the conference page"
              />
            </div>
            ...
            <div className="az-grid-col-2">
              <Input
                ...
                placeholder="Brief one-line overview shown on listings cards"
              />
            </div>
            ...
            <div className="az-grid-col-2">
              <Textarea
                ...
                placeholder="Detailed scope, research themes, tracks, and keynote summaries..."
            ...
            <div className="az-grid-col-2">
              <Input
                ...
                helperText="High-resolution banner graphic (16:9 ratio recommended)"
              />
            </div>
          </div>
        </section>
          ...
          <div className="az-admin-form-grid">
            ...
            <div>
              <Input
                ...
                helperText="Final date for participant registration"
              />
            </div>
            ...
            <div>
              <Input
                ...
                helperText="Final date for peer review paper submissions"
              />
            </div>
          </div>
        </section>
          ...
          <div className="az-admin-form-grid">
            ...
            <div className="az-grid-col-2">
              <Input
                ...
                placeholder="e.g. Grand Convention Center & Ballroom"
              />
            </div>
          </div>
        </section>
          ...
          <div className="az-admin-form-grid">
            ...
            <div>
              <Input
                ...
                helperText="e.g. Deep Learning, Robotics, Ethics"
              />
            </div>
